# PreCare AI – Health Risk Prediction System
...
1. The user enters health information such as age, diet, physical activity, symptoms, and family medical history.
2. The system evaluates these inputs using a health risk scoring algorithm.
3. A disease risk percentage is calculated.
4. Preventive health recommendations are provided.
5. The AI assistant chatbot explains risk factors and provides guidance.
